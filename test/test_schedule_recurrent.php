...
/**
* This scripts tests creating recurrent
*/
...
// set the task name
$client->setTaskName('Businessday Monthly Subscription Reminder Improved');
// set the task description, not more than 160 characters
$client->setTaskDescription(
'Bill this customer again for another month of subscription improved');
...
// $client->setDayOfMonth(31);
// set the period length in this case 3
$client->setPeriodLength(1);
